...
export const childInfoSeed: Record<string, ChildInfo> = {
  ...
  // Загальноосвітня школа I ступеня "Чайка" — данные требуют уточнения у администрации
  'place-136': {
    category: 'school',
    ageFrom: 6,
    ageTo: 10,
    shortDescription: 'Початкова школа району. Умови навчання, графік та набір потрібно уточнювати у закладі.',
  },

  // Заклад дошкільної освіти №747 "Берізка" — данные требуют уточнения у администрации
  'place-138': {
    category: 'kindergarten',
    ageFrom: 2,
    ageTo: 6,
    shortDescription: 'Дошкільний заклад у районі. Наявність місць, графік та умови потрібно уточнювати у закладі.',
  },

  // Клуб бального танца "Диамант-Элит" — данные требуют уточнения у клуба
  'place-140': {
    category: 'sport',
    ageFrom: 4,
    shortDescription: 'Клуб бального танцю для дітей. Розклад, вік груп і вартість потрібно уточнювати у клубі.',
    features: ['sport'],
  },

  // Міжнародний ліцей Михаїл — данные требуют уточнения у администрации
  'place-142': {
    category: 'school',
    ageFrom: 6,
    shortDescription: 'Ліцей у районі. Програму, графік, вартість та умови вступу потрібно уточнювати у закладі.',
  },
};
