...
export const normalizeRemoteAppControlConfig = (value: unknown): RemoteAppControlConfig => {
  ...
  return {
    app_enabled: normalizeBoolean(raw.app_enabled, DEFAULT_REMOTE_APP_CONTROL_CONFIG.app_enabled),
    maintenance_mode: normalizeBoolean(raw.maintenance_mode, DEFAULT_REMOTE_APP_CONTROL_CONFIG.maintenance_mode, false),
    ...
    force_update_required: normalizeBoolean(raw.force_update_required, DEFAULT_REMOTE_APP_CONTROL_CONFIG.force_update_required, false),
    allow_new_devices: normalizeBoolean(raw.allow_new_devices, DEFAULT_REMOTE_APP_CONTROL_CONFIG.allow_new_devices, false),
    beta_mode_enabled: normalizeBoolean(raw.beta_mode_enabled, DEFAULT_REMOTE_APP_CONTROL_CONFIG.beta_mode_enabled, false),
